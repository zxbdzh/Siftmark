...
export function QuickSave({ service, tab, folders = [], defaultFolderId, recentOperationId, destinationHint, queueAnalysis = true, onSaved, onUndo }: QuickSaveProps) {
